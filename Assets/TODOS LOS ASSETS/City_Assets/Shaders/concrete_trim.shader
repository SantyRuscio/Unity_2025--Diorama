Shader "Unreal/concrete_trim"
{
    Properties
    {
		...
		Material_Texture2D_0( "concrete_trim_n", 2D ) = "white" {}
		Material_Texture2D_1( "concrete_trim_c", 2D ) = "white" {}
		Material_Texture2D_2( "concrete_trim_g", 2D ) = "white" {}
