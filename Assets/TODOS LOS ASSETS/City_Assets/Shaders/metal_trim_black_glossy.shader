Shader "Unreal/metal_trim_black_glossy"
{
    Properties
    {
		...
		Material_Texture2D_0( "beam_window_supports_metal_n", 2D ) = "white" {}
		Material_Texture2D_1( "beam_window_supports_metal_c", 2D ) = "white" {}
		Material_Texture2D_2( "beam_window_supports_metal_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "metal_trim_black_glossy.hlsl"
