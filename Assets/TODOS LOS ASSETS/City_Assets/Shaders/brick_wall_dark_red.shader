Shader "Unreal/brick_wall_dark_red"
{
    Properties
    {
		...
		Material_Texture2D_0( "brick_wall_tiling_n", 2D ) = "white" {}
		Material_Texture2D_1( "brick_wall_tiling_c_dark_red", 2D ) = "white" {}
		Material_Texture2D_2( "brick_wall_tiling_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "brick_wall_dark_red.hlsl"
