...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.035000,0.035000,0.035000,4.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.250000,10.000000,1.400000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local9 = (Local8 * ((MaterialFloat3)0.20000000));
	...
	MaterialFloat Local13 = (Local11.a * Material.PreshaderBuffer[2].x);
	MaterialFloat Local14 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local15 = max(0.00000000,Local14);
	MaterialFloat Local16 = (1.00000000 - Local15);
	MaterialFloat Local17 = abs(Local16);
	MaterialFloat Local18 = max(Local17,0.00010000);
	MaterialFloat Local19 = PositiveClampedPow(Local18,Material.PreshaderBuffer[2].y);
	MaterialFloat Local20 = (Local19 + 0.00000000);
	MaterialFloat Local21 = lerp(1.00000000,Material.PreshaderBuffer[2].z,Local20);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local21,0.0f),Material.PreshaderBuffer[2].w);
