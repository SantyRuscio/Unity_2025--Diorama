Shader "Unreal/dirt_pebble_pile"
{
    Properties
    {
		...
		Material_Texture2D_0( "grunge_dirt_pebble_pile_a_n", 2D ) = "white" {}
		Material_Texture2D_1( "grunge_dirt_pebble_pile_a_c", 2D ) = "white" {}
		Material_Texture2D_2( "grunge_dirt_pebble_pile_a_g", 2D ) = "white" {}
