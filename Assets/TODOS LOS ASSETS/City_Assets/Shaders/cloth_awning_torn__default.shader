Shader "Unreal/cloth_awning_torn__default"
{
    Properties
    {
		...
		Material_Texture2D_0( "cloth_awning_torn_n", 2D ) = "white" {}
		Material_Texture2D_1( "cloth_awning_torn_c", 2D ) = "white" {}
		Material_Texture2D_2( "cloth_awning_torn_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "cloth_awning_torn__default.hlsl"
