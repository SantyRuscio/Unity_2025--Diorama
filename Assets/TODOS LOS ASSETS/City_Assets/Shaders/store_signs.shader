Shader "Unreal/store_signs"
{
    Properties
    {
		...
		Material_Texture2D_0( "signs_decals_chinese_stores_n", 2D ) = "white" {}
		Material_Texture2D_1( "signs_decals_chinese_stores_c", 2D ) = "white" {}
		Material_Texture2D_2( "signs_decals_chinese_stores_g", 2D ) = "white" {}
