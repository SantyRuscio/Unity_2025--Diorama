...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.200000,10.000000,1.400000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local15 = PositiveClampedPow(Local14,Material.PreshaderBuffer[2].y);
	MaterialFloat Local16 = (Local15 + 0.00000000);
	MaterialFloat Local17 = lerp(1.00000000,Material.PreshaderBuffer[2].z,Local16);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local17,0.0f),Material.PreshaderBuffer[2].w);
