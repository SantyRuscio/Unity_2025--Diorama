...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.002900,0.009766,0.020000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local11 = lerp((0.00000000 - 0.00000000),(0.00000000 + 1.00000000),Local9.b);
	MaterialFloat Local12 = saturate(Local11);
	MaterialFloat3 Local13 = lerp(Local6.rgb,Material.PreshaderBuffer[1].xyz,Local12.r);
	MaterialFloat3 Local14 = (Local13 * ((MaterialFloat3)Local9.a));
	...
	PixelMaterialInputs.Specular = Local9.r;
	PixelMaterialInputs.Roughness = Local9.g;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local16.rgb;
