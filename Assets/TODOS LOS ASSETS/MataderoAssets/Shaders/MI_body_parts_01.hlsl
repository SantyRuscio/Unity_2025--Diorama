...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,0.500000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.500000,0.500000,0.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local9 = (Material.PreshaderBuffer[1].xyz * Local8);
	MaterialFloat3 Local10 = (((MaterialFloat3)1.00000000) - Local9);
	MaterialFloat3 Local11 = (Material.PreshaderBuffer[2].xyz * Local6.rgb);
	MaterialFloat Local12 = select((Material.PreshaderBuffer[2].w >= 0.50000000), Local10.r, Local11.r);
	MaterialFloat Local13 = select((Material.PreshaderBuffer[3].x >= 0.50000000), Local10.g, Local11.g);
	MaterialFloat Local14 = select((Material.PreshaderBuffer[3].y >= 0.50000000), Local10.b, Local11.b);
	...
	PixelMaterialInputs.BaseColor = MaterialFloat3(MaterialFloat2(Local12,Local13),Local14);
