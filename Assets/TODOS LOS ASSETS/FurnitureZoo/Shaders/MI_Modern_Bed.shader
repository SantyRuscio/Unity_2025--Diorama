Shader "Unreal/MI_Modern_Bed"
{
    Properties
    {
		...
		Material_Texture2D_0( "Blanket Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "Normal Map", 2D ) = "white" {}
		Material_Texture2D_2( "Color Mask", 2D ) = "white" {}
		Material_Texture2D_3( "Botom Part 2 Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_4( "Bottom Part Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_5( "Botom Part 2 Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "Bottom Part Albedo", 2D ) = "white" {}
		Material_Texture2D_7( "Blanket Albedo", 2D ) = "white" {}
		Material_Texture2D_8( "Blanket Roughness Noise", 2D ) = "white" {}
		Material_Texture2D_9( "Botom Part 2 Roughness Map", 2D ) = "white" {}
