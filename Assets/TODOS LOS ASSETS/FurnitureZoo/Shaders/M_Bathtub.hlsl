...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.979167,0.979167,0.979167,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.674510,0.674510,0.674510,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.965278,0.965278,0.965278,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.937500,0.892999,0.706380,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[1].xyz,Local6.b);
	MaterialFloat3 Local9 = lerp(Local8,Material.PreshaderBuffer[2].xyz,Local6.r);
	MaterialFloat3 Local10 = lerp(Local9,Material.PreshaderBuffer[3].xyz,Local6.g);
	MaterialFloat3 Local11 = lerp(Local10,Material.PreshaderBuffer[4].xyz,Local6.a.r);
	MaterialFloat Local12 = lerp(0.00000000,0.25000000,Local6.b);
	MaterialFloat Local13 = lerp(Local12,0.10000000,Local6.r);
	MaterialFloat Local14 = lerp(Local13,0.30000001,Local6.g);
	MaterialFloat Local15 = lerp(Local14,0.30000001,Local6.a.r);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local11;
	PixelMaterialInputs.Metallic = Local6.r;
