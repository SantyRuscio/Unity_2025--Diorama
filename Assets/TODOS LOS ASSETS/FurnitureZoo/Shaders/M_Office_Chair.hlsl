...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local8 = lerp(((MaterialFloat4)0.00000000),MaterialFloat4(0.14236109,0.03628138,0.01061397,0.00000000).rgba,Local6.r);
	MaterialFloat4 Local9 = lerp(((MaterialFloat4)0.00000000),MaterialFloat4(0.04513891,0.04513891,0.04513891,0.00000000).rgba,Local6.b);
	MaterialFloat4 Local10 = (Local8 + Local9);
	MaterialFloat4 Local11 = lerp(((MaterialFloat4)0.00000000),MaterialFloat4(0.54513890,0.54513890,0.54513890,0.00000000).rgba,Local6.g);
	MaterialFloat4 Local12 = (Local10 + Local11);
	MaterialFloat4 Local13 = lerp(((MaterialFloat4)0.00000000),MaterialFloat4(0.04861109,0.04861109,0.04861109,0.00000000).rgba,Local6.a);
	MaterialFloat4 Local14 = (Local12 + Local13);
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local16 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 0);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local14.xyz;
	PixelMaterialInputs.Metallic = Local16.r;
