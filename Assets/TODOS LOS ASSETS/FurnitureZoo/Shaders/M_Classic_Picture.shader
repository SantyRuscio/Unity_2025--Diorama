Shader "Unreal/M_Classic_Picture"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Classic_Picture_n", 2D ) = "white" {}
		Material_Texture2D_1( "T_Classic_Picture_A", 2D ) = "white" {}
		Material_Texture2D_2( "T_Classic_Picture_M_R_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Classic_Picture.hlsl"
