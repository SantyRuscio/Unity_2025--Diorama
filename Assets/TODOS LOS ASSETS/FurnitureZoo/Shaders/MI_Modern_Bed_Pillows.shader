Shader "Unreal/MI_Modern_Bed_Pillows"
{
    Properties
    {
		...
		Material_Texture2D_0( "Pillows 1 Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "Normal Map", 2D ) = "white" {}
		Material_Texture2D_2( "Color Mask", 2D ) = "white" {}
		Material_Texture2D_3( "Pillows 2 Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_4( "Pillows 3 Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_5( "Pillows 2 Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "Pillows 3 Albedo", 2D ) = "white" {}
		Material_Texture2D_7( "Pillows 1 Albedo", 2D ) = "white" {}
		Material_Texture2D_8( "Pillows 1 Roughness Noise", 2D ) = "white" {}
		Material_Texture2D_9( "Pillows 2 Roughness Noise", 2D ) = "white" {}
		Material_Texture2D_10( "Pillows 3 Roughness Noise", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Modern_Bed_Pillows.hlsl"
