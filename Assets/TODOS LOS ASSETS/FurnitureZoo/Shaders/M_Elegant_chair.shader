Shader "Unreal/M_Elegant_chair"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Elegant_chair_n", 2D ) = "white" {}
		Material_Texture2D_1( "T_Elegant_chair_a", 2D ) = "white" {}
		Material_Texture2D_2( "T_Elegant_chair_m_r_ao", 2D ) = "white" {}
