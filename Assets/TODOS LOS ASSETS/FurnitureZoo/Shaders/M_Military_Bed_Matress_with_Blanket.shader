Shader "Unreal/M_Military_Bed_Matress_with_Blanket"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Military_Bed_Mattress_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Military_Bed_Mattress_A", 2D ) = "white" {}
		Material_Texture2D_2( "T_Military_Bed_Mattress_R_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Military_Bed_Matress_with_Blanket.hlsl"
