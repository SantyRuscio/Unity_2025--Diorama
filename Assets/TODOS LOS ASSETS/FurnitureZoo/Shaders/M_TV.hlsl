...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.040887,0.041667,0.041383,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.006944,0.006944,0.006944,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.920139,0.920139,0.920139,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.399306,0.399306,0.399306,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local5 = lerp(Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].xyz,Local3.r);
	MaterialFloat3 Local6 = lerp(Local5,Material.PreshaderBuffer[3].xyz,Local3.g);
	MaterialFloat3 Local7 = lerp(Local6,Material.PreshaderBuffer[4].xyz,Local3.a.r);
	MaterialFloat Local8 = lerp(Local3.g,0.50000000,Local3.a.r);
	MaterialFloat Local9 = lerp(0.40000001,0.20000000,Local3.r);
	MaterialFloat Local10 = lerp(Local9,0.10000000,Local3.g);
	MaterialFloat Local11 = lerp(Local10,0.30000001,Local3.a.r);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local7;
	PixelMaterialInputs.Metallic = Local8;
