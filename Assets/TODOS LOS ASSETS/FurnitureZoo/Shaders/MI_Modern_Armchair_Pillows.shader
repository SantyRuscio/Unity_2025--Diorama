Shader "Unreal/MI_Modern_Armchair_Pillows"
{
    Properties
    {
		...
		Material_Texture2D_0( "Main Part Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "Normal Map", 2D ) = "white" {}
		Material_Texture2D_2( "Color Mask", 2D ) = "white" {}
		Material_Texture2D_3( "Pillows Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_4( "Bottom Part Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_5( "Pillows Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "Bottom Part Albedo", 2D ) = "white" {}
		Material_Texture2D_7( "Main Part Albedo", 2D ) = "white" {}
		Material_Texture2D_8( "Main Part Roughness Map", 2D ) = "white" {}
		Material_Texture2D_9( "Pillows Roughness Map", 2D ) = "white" {}
		Material_Texture2D_10( "Bottom Part Roughness Map", 2D ) = "white" {}
		Material_Texture2D_11( "AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Modern_Armchair_Pillows.hlsl"
