...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.965278,0.965278,0.965278,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.674510,0.674510,0.674510,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.972222,0.972222,0.972222,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = lerp(Material.PreshaderBuffer[1].xyz,((MaterialFloat3)1.00000000),Local6.r);
	MaterialFloat3 Local9 = lerp(Local8,Material.PreshaderBuffer[2].xyz,Local6.b);
	MaterialFloat3 Local10 = lerp(Local9,Material.PreshaderBuffer[3].xyz,Local6.g);
	MaterialFloat Local11 = lerp(0.00000000,0.20000000,Local6.r);
	MaterialFloat Local12 = lerp(Local11,0.10000000,Local6.b);
	MaterialFloat Local13 = lerp(Local12,0.20000000,Local6.g);
