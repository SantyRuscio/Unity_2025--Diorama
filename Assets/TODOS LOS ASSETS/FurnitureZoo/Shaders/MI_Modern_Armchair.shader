Shader "Unreal/MI_Modern_Armchair"
{
    Properties
    {
		...
		Material_Texture2D_3( "Bottom Part Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_4( "Bottom Part Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "Main Part Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "Main Part Roughness Map", 2D ) = "white" {}
		Material_Texture2D_7( "Bottom Part Roughness Map", 2D ) = "white" {}
		Material_Texture2D_8( "AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Modern_Armchair.hlsl"
