Shader "Unreal/M_Classic_Leather_armchair"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Leather_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Classic_Leather_Armchair_n", 2D ) = "white" {}
		Material_Texture2D_2( "T_Classic_Leather_Armchair_a", 2D ) = "white" {}
		Material_Texture2D_3( "T_Leather_armchair_m_r_ao", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Classic_Leather_armchair.hlsl"
