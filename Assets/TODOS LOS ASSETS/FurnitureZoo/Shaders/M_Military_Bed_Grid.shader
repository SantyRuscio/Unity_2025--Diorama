Shader "Unreal/M_Military_Bed_Grid"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Military_Bed_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Military_Bed_A", 2D ) = "white" {}
		Material_Texture2D_2( "T_Military_Bed_M_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Military_Bed_Grid.hlsl"
