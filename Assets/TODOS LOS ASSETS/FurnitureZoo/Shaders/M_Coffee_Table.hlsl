...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.086806,0.043299,0.018687,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.674510,0.674510,0.674510,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.041667,0.041667,0.041667,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local5 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[1].xyz,Local3.r);
	MaterialFloat3 Local6 = lerp(Local5,Material.PreshaderBuffer[2].xyz,Local3.g);
	MaterialFloat3 Local7 = lerp(Local6,Material.PreshaderBuffer[3].xyz,Local3.b);
	MaterialFloat Local8 = lerp(0.00000000,0.20000000,Local3.r);
	MaterialFloat Local9 = lerp(Local8,0.15000001,Local3.g);
	MaterialFloat Local10 = lerp(Local9,0.50000000,Local3.b);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local7;
	PixelMaterialInputs.Metallic = Local3.g;
