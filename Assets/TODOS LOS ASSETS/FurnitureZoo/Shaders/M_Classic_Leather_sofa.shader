Shader "Unreal/M_Classic_Leather_sofa"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Classic_Leather_sofa_n", 2D ) = "white" {}
		Material_Texture2D_2( "T_Classic_Leather_sofa_a", 2D ) = "white" {}
		Material_Texture2D_3( "T_Classic_Leather_sofa_m_r_ao", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Classic_Leather_sofa.hlsl"
