Shader "Unreal/MI_Modern_Bed_Table"
{
    Properties
    {
		...
		Material_Texture2D_0( "Bottom Part Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_1( "Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Mask", 2D ) = "white" {}
		Material_Texture2D_3( "Top Detail Normal Map", 2D ) = "white" {}
		Material_Texture2D_4( "Top Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "Bottom Part Albedo", 2D ) = "white" {}
		Material_Texture2D_6( "AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Modern_Bed_Table.hlsl"
