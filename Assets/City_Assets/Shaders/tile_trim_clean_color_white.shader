Shader "Unreal/tile_trim_clean_color_white"
{
    Properties
    {
		...
		Material_Texture2D_0( "tiles_wall_clean_n", 2D ) = "white" {}
		Material_Texture2D_1( "tiles_wall_clean_c", 2D ) = "white" {}
		Material_Texture2D_2( "tiles_wall_clean_g", 2D ) = "white" {}
		Material_Texture2D_3( "tiles_wall_clean_ao", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "tile_trim_clean_color_white.hlsl"
