Shader "Unreal/Glass_Cracked"
{
    Properties
    {
		...
		Material_Texture2D_0( "glass_window_broken_n", 2D ) = "white" {}
		Material_Texture2D_1( "glass_window_broken_g", 2D ) = "white" {}
		Material_Texture2D_2( "window_spec", 2D ) = "white" {}
