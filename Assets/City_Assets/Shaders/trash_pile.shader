Shader "Unreal/trash_pile"
{
    Properties
    {
		...
		Material_Texture2D_0( "grunge_rubble_pile_n", 2D ) = "white" {}
		Material_Texture2D_1( "grunge_rubble_pile_c", 2D ) = "white" {}
		Material_Texture2D_2( "grunge_rubble_pile_g", 2D ) = "white" {}
