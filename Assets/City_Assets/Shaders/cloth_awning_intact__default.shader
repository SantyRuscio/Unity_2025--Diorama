Shader "Unreal/cloth_awning_intact__default"
{
    Properties
    {
		...
		Material_Texture2D_0( "cloth_awning_intact_n", 2D ) = "white" {}
		Material_Texture2D_1( "cloth_awning_intact_c", 2D ) = "white" {}
		Material_Texture2D_2( "cloth_awning_intact_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "cloth_awning_intact__default.hlsl"
