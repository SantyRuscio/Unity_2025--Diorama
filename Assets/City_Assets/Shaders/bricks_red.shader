Shader "Unreal/bricks_red"
{
    Properties
    {
		...
		Material_Texture2D_0( "bricks_red_n", 2D ) = "white" {}
		Material_Texture2D_1( "bricks_red_c", 2D ) = "white" {}
		Material_Texture2D_2( "bricks_red_g", 2D ) = "white" {}
