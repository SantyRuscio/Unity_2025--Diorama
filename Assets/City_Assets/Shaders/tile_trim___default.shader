Shader "Unreal/tile_trim___default"
{
    Properties
    {
		...
		Material_Texture2D_0( "tiles_wall_broken_n", 2D ) = "white" {}
		Material_Texture2D_1( "tiles_wall_broken_c", 2D ) = "white" {}
		Material_Texture2D_2( "tiles_wall_broken_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "tile_trim___default.hlsl"
