Shader "Unreal/metal_shutters"
{
    Properties
    {
		...
		Material_Texture2D_0( "window_store_shutters_n", 2D ) = "white" {}
		Material_Texture2D_1( "window_store_shutters_c", 2D ) = "white" {}
		Material_Texture2D_2( "window_store_shutters_g", 2D ) = "white" {}
