Shader "Unreal/Glass_Shards"
{
    Properties
    {
		...
		Material_Texture2D_0( "glass_shards_n", 2D ) = "white" {}
		Material_Texture2D_1( "window_spec", 2D ) = "white" {}
		Material_Texture2D_2( "glass_shards_c", 2D ) = "white" {}
