Shader "Unreal/ground_gravel_dirt"
{
    Properties
    {
		...
		Material_Texture2D_0( "ground_gravel_dirt_n", 2D ) = "white" {}
		Material_Texture2D_1( "ground_gravel_dirt_c", 2D ) = "white" {}
		Material_Texture2D_2( "ground_gravel_dirt_g", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "ground_gravel_dirt.hlsl"
