...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.002000,0.001970,0.001772,0.095098);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.404902,0.000000,0.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local11 = lerp(Local6.rgb,Material.PreshaderBuffer[1].xyz,Local9.b);
	MaterialFloat3 Local12 = (Local11 * ((MaterialFloat3)Local9.a));
	MaterialFloat Local13 = (Material.PreshaderBuffer[1].w + Local9.r);
	MaterialFloat Local14 = (Local9.g * Material.PreshaderBuffer[2].x);
	...
	PixelMaterialInputs.Specular = Local13;
