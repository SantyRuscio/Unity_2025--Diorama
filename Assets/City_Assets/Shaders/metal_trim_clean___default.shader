Shader "Unreal/metal_trim_clean___default"
{
    Properties
    {
		...
		Material_Texture2D_0( "beam_window_supports_metal_clean_n", 2D ) = "white" {}
		Material_Texture2D_1( "beam_window_supports_metal_clean_c", 2D ) = "white" {}
		Material_Texture2D_2( "beam_window_supports_metal_clean_g", 2D ) = "white" {}
		Material_Texture2D_3( "beam_window_supports_metal_ao", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "metal_trim_clean___default.hlsl"
